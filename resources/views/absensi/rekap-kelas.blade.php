                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-dark-200/50">
                        ...
                        @forelse ($rekap as $r)
                            ...
                            @endphp
                            <tr
                                class="hover:bg-dark-50/50 transition-colors duration-200 {{ $isNewDate ? 'border-t-2 border-dark-200' : '' }}">
                                ...
                                <td class="px-6 py-3.5 text-sm font-bold text-dark-700 text-center">
                                    {{ $r['total_peserta'] }}
                                </td>
                                <td class="px-6 py-3.5 text-center">
                                    <span
